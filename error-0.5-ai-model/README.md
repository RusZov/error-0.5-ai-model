...
Научный проект для анализа согласованности и неопределённости ответов языковых моделей на основе теории «ошибки 0.5».

## 📖 Описание

Этот проект реализует научную теорию «ошибки 0.5» для оценки:
...
Теория «ошибки 0.5» предполагает, что:
